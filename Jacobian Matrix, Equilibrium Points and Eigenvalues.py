...
H1 = A1
H1Subs = sp.Subs(H1, (x, y, z, r, k, b, a, n, m, u, a1, p, n1), (0.1194522936,0.1667424272,0.3393851516, 0.82, 12, 0.87, 1.56, 2.41, 0.13, 0.11, 1.12, 1.38, 1.83)).doit()
print(f"H1: {H1Subs}")

print(separator)

H2 = A1*A2-A3
H2Subs = sp.Subs(H2, (x, y, z, r, k, b, a, n, m, u, a1, p, n1),
                 (0.1194522936,0.1667424272,0.3393851516, 0.82, 12, 0.87, 1.56, 2.41, 0.13, 0.11, 1.12, 1.38, 1.83)).doit()
print(f"H2: {H2Subs}")

print(separator)

H3 = A1*A2*A3-A3*A3
H3Subs = sp.Subs(H3, (x, y, z, r, k, b, a, n, m, u, a1, p, n1),
                 (0.1194522936,0.1667424272,0.3393851516, 0.82, 12, 0.87, 1.56, 2.41, 0.13, 0.11, 1.12, 1.38, 1.83)).doit()
print(f"H3: {H3Subs}")
