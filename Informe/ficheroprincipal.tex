...
\end{center}
Haciendo los c\'aculos peretinentes se obtienen como resultado los siguinetes valores.
$E_1$ = (0,0,0), $E_2$ = $(\frac{k(r-\beta)}{r}, \frac{\beta k(r-\beta)}{\mu r}, 0)$ y $E_3$ = ($x^*,y^*,z^*$) Que vamos a hacer con esto??

Para realizar el analisis de los puntos de equilibrio hallamos la matriz Jacobina del modelo, la cual está dada por:
...
Al realizar el c\'alculo de los auto valores en los distintos puntos de equilibrio podemos observar lo siguiente.
...
\begin{equation} \label{Characteristic000}
	...
	\end{array}\right|=0
\end{equation}
Los valores propios de la matriz J(E1) son ((-1 + r) - $\lambda$)(-$\mu$ - $\lambda$)(0 - $\lambda$) = 0. Siempre se tiene que $\lambda_1$ = -$\mu$, 
