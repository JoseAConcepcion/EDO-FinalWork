...
xpob_inicial = 306  # población inicial de presas jóvenes
ypob_inicial = 40  # población inicial de presas adultas
zpob_inicial = 15  # población inicial de depredadores
duracion = 5  # tiempo de estudio de las poblaciones
cortes = 1  # candidad de valores requeridos por unidad de tiempo
